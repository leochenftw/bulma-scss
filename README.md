...
You can either use that file, "out of the box", or download the scss source files to customize the [variables](http://bulma.io/documentation/overview/variables/).
